...
const navLinks = [
  ...
  { href: "#internship", text: "My Internship" },     // FIXED
  { href: "#certifications", text: "Certifications" }, // FIXED
  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Aniket Kamde</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Aniket Kamde. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
